package com.reasure.neoforge_tutorial.trim;
...
public class ModTrimMaterials {
    public static final ResourceKey<TrimMaterial> BLACK_OPAL =
            ResourceKey.create(Registries.TRIM_MATERIAL, ResourceLocation.fromNamespaceAndPath(NeoforgeTutorial.MODID, "black_opal"));
