package com.reasure.neoforge_tutorial.fluid;
...
public class ModFluids {
    public static final DeferredRegister<Fluid> FLUIDS = DeferredRegister.create(Registries.FLUID, NeoforgeTutorial.MODID);
    ...
    public static final DeferredBlock<LiquidBlock> BLACK_OPAL_WATER_BLOCK = ModBlocks.BLOCKS.register("black_opal_water_block",
            () -> new LiquidBlock(ModFluids.SOURCE_BLACK_OPAL_WATER.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).mapColor(MapColor.COLOR_BLACK).noLootTable()));
    ...
    public static final BaseFlowingFluid.Properties BLACK_OPAL_WATER_PROPERTIES = new BaseFlowingFluid.Properties(
            ...
            .block(ModFluids.BLACK_OPAL_WATER_BLOCK)
            .bucket(ModFluids.BLACK_OPAL_WATER_BUCKET);
